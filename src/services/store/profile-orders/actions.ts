...
export const profileOrdersConnect = createAction<string, 'PROFILE_ORDERS_CONNECT'>('PROFILE_ORDERS_CONNECT');
export const profileOrdersDisconnect = createAction("PROFILE_ORDERS_DISCONNECT");

export const profileOrdersWsConnecting = createAction("PROFILE_ORDERS_WS_CONNECTING");
...
export const profileOrdersWsError = createAction<string, "PROFILE_ORDERS_WS_ERROR">("PROFILE_ORDERS_WS_ERROR");
export const profileOrdersWsMessage = createAction<TPayload, "PROFILE_ORDERS_WS_MESSAGE">("PROFILE_ORDERS_WS_MESSAGE");

export type TProfileOrdersActions = ReturnType<typeof profileOrdersConnect>
